 ...
 * 更新任务开始日期和结束日期
 */
public class UpdateTaskDatelineActivity extends BaseActivity implements View.OnClickListener {
...
//        starttime.setText(DateUtil.getDateAndTimeTwo());
    ...
    public void onClick(View view) {
        switch (view.getId()){
                ...
                break; case R.id.liner_starttime:
            {
                    ...
                    new DoubleDatePickerDialog(UpdateTaskDatelineActivity.this, 0, new DoubleDatePickerDialog.OnDateSetListener() {
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code1) == 200) {
                                    showMsg(UpdateTaskDatelineActivity.this, "更新任务日期成功！");
                                    Intent intent1 = new Intent("update_task_end_dateline_success");
                                    sendBroadcast(intent1);
                                    finish();
                                } else {
                                    Toast.makeText(UpdateTaskDatelineActivity.this, jo.getString("message"), Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        } else {
                            Toast.makeText(UpdateTaskDatelineActivity.this, R.string.add_failed, Toast.LENGTH_SHORT).show();
                        }
    ...
    public void saveTaskDatelineAction(View view){
        if(StringUtil.isNullOrEmpty(starttime.getText().toString()) || StringUtil.isNullOrEmpty(endtime.getText().toString())){
            showMsg(UpdateTaskDatelineActivity.this, "请选择日期");
            return;
        }
        updateDateline();
    }
