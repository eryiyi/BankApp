 ...
 * 已完成备忘录
 */
public class MemoListDoneActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        progressDialog = new CustomProgressDialog(MemoListDoneActivity.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    private void initView() {
        ...
        title.setText("已完成备忘录");

        adapter = new ItemMemoAdapter(lists, MemoListDoneActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.right_btn:
                //添加备忘录
            {
                Intent intent = new Intent(MemoListDoneActivity.this, AddMemoActivity.class);
                startActivity(intent);
            }
                break;
        }
    ...
    private void initData() {
        StringRequest request = new StringRequest(
                Request.Method.POST,
                InternetURL.MOME_NOTE_DONE_LIST_URL,
                        ...
                        if (StringUtil.isJson(s)) {
                            ...
                            try {
                                ...
                                if (Integer.parseInt(code1) == 200) {
                                    ...
                                    Toast.makeText(MemoListDoneActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
