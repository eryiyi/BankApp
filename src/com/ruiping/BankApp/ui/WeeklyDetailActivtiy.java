 ...
 * 周报详情
 */
public class WeeklyDetailActivtiy extends BaseActivity implements View.OnClickListener , ContentListView.OnRefreshListener, ContentListView.OnLoadListener{
    ...
    private void initView() {
        ...
        headLiner = (LinearLayout) LayoutInflater.from(WeeklyDetailActivtiy.this).inflate(R.layout.weekly_detail_header, null);
        ...
        adapter = new ItemCommentAdapter(lists, WeeklyDetailActivtiy.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position-2 < lists.size()){
                    ...
                    Intent intent = new Intent(WeeklyDetailActivtiy.this, AddDailyCommentActivity.class);
        ...
        adapterT = new ItemDoneAdapter(listsDone, WeeklyDetailActivtiy.this);
        ...
        switch (v.getId()){
                ...
                //添加评论
            {
                if(bankJobReport != null){
                    ...
                    showMsg(WeeklyDetailActivtiy.this, "请先添加周报！");
                    return;
                }
            }
                break;
            case R.id.btn_attachment:
            {
                if(bankJobReport != null){
                    //附件查看
                    Intent intent  = new Intent(WeeklyDetailActivtiy.this, AttachMentActivity.class);
                    ...
                    Intent intent  = new Intent(WeeklyDetailActivtiy.this, AttachMentUpWeekActivity.class);
            ...
            {
                if(flag){
                    Intent intent = new Intent(WeeklyDetailActivtiy.this, WriteContentActivity.class);
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (data.getCode() == 200) {
                                ...
                                Toast.makeText(WeeklyDetailActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(WeeklyDetailActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                        }
...
//                                    finish();
                            ...
                            Toast.makeText(WeeklyDetailActivtiy.this, R.string.add_failed, Toast.LENGTH_SHORT).show();
                        }
                        if(progressDialog != null){
                            progressDialog.dismiss();
                        }
    ...
    void getDetailById(){
        //判断是否有网
        try {
            isMobileNet = HttpUtils.isMobileDataEnable(WeeklyDetailActivtiy.this);
            isWifiNet = HttpUtils.isWifiDataEnable(WeeklyDetailActivtiy.this);
            if (!isMobileNet && !isWifiNet) {
                showMsg(WeeklyDetailActivtiy.this, "请检查您的网络链接");
            } else {
                StringRequest request = new StringRequest(
                        Request.Method.POST,
