 ...
 * 添加年中报告
 */
public class AddYearMiddleActivtiy extends BaseActivity implements View.OnClickListener ,OnClickContentItemListener {
    //标准配置
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_mine_year_middle_activity);
        initView();

        progressDialog = new CustomProgressDialog(AddYearMiddleActivtiy.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    void initDataViewTwo(){
        if(bankJobReportTwo == null){
            ...
            nickname2.setText(getGson().fromJson(getSp().getString(Contance.EMP_NAME, ""), String.class) + "的"+DateUtil.getYear()+ "年年中工作报告");

            dateline2.setText(DateUtil.getYear() + "年年中");
            week2.setText(DateUtil.getYear()+".01-"+ DateUtil.getYear()+".06" );
    ...
    private void initViewTwo() {
        ...
        headLiner2 = (LinearLayout) LayoutInflater.from(AddYearMiddleActivtiy.this).inflate(R.layout.add_mine_year_middle_header, null);
        ...
        adapter2 = new ItemSelectFileAdapter(dataListTwoName, AddYearMiddleActivtiy.this);
        ...
        switch (view.getId()){
            ...
            case R.id.right_btn:
            {
                    ...
                    if(StringUtil.isNullOrEmpty(content_one2.getText().toString())){
                        showMsg(AddYearMiddleActivtiy.this, "请输入工作成效！");
                        return;
                    }
...
//                    }
            ...
            case R.id.btn_attachment:
            {
                ...
                if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
                {
                    ...
                    showMsg(AddYearMiddleActivtiy.this, getResources().getString(R.string.sdcard_unmonted_hint));
                }
            }
            break;
            case R.id.content_one:
            {
                    ...
                    Intent intent = new Intent(AddYearMiddleActivtiy.this, WriteContentActivity.class);
...
//            showMsg(WeeklyDetailActivtiy.this, getResources().getString(R.string.open_file_none));
        ...
        if(resultCode == RESULT_OK && requestCode == REQUEST_CODE){
            ...
            if(pptPath != null){
                ...
                showMsg(AddYearMiddleActivtiy.this, getResources().getString(R.string.open_file_failed));
            }
        }
    ...
    private void getWeekDateTwo() {
        StringRequest request = new StringRequest(
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code1) == 200) {
                                    ...
                                    Toast.makeText(AddYearMiddleActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("weekCount", DateUtil.getYear() +"年年中");//2016年年中
...
//                                    跳转到周报详情页面
                                    ...
                                    showMsg(AddYearMiddleActivtiy.this, jo.getString("message"));
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                            ...
                            Toast.makeText(AddYearMiddleActivtiy.this, R.string.add_failed, Toast.LENGTH_SHORT).show();
                        }
                        if(progressDialog != null){
                            progressDialog.dismiss();
                        }
