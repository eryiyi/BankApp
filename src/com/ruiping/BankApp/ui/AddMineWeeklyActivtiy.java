 ...
 * 添加周报
 */
public class AddMineWeeklyActivtiy extends BaseActivity implements View.OnClickListener ,OnClickContentItemListener {
    //标准配置
    ...
    //顶部banner
    private TextView btn_left;//上周
    private TextView btn_right;//本周
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_mine_weekly_activity);
        initView();

        progressDialog = new CustomProgressDialog(AddMineWeeklyActivtiy.this, "正在加载中",R.anim.custom_dialog_frame);
        progressDialog.setCancelable(true);
        progressDialog.setIndeterminate(true);
        progressDialog.show();

        currentWeek = DateUtil.getWeekOfYear(new Date());
        initViewOne();
        initViewTwo();
    ...
    void initDataViewOneNull(){
        ...
        nickname1.setText(getGson().fromJson(getSp().getString(Contance.EMP_NAME, ""), String.class) + "暂无上周工作报告");
        dateline1.setText("暂无上周工作报告");
        week1.setText("暂无上周工作报告");
    ...
    private void initViewOne() {
        ...
        headLiner1 = (LinearLayout) LayoutInflater.from(AddMineWeeklyActivtiy.this).inflate(R.layout.add_mine_weekly_header, null);
        ...
        adapter1 = new ItemSelectFileAdapter(dataListOneName, AddMineWeeklyActivtiy.this);
    ...
    void initDataViewOne(){
        if(bankJobReportOne == null){
            imageLoader.displayImage(InternetURL.INTERNAL + getGson().fromJson(getSp().getString(Contance.EMP_COVER, ""), String.class), head1, animateFirstListener);
            nickname1.setText(getGson().fromJson(getSp().getString(Contance.EMP_NAME, ""), String.class) + "的第"+ (currentWeek-1) +"周工作报告");
            dateline1.setText("第"+ String.valueOf(currentWeek-1)+"周");
            week1.setText(DateUtil.getStartDayOfWeekNo(Integer.parseInt(DateUtil.getYear()), (currentWeek-1)) + "-" + DateUtil.getEndDayOfWeekNo(Integer.parseInt(DateUtil.getYear()), (currentWeek-1)));
        }else {
    ...
    void initDataViewTwo(){
        if(bankJobReportTwo == null){
            ...
            nickname2.setText(getGson().fromJson(getSp().getString(Contance.EMP_NAME, ""), String.class) + "的第"+ currentWeek +"周工作报告");
            dateline2.setText("第"+ String.valueOf(currentWeek)+"周");
            week2.setText(DateUtil.getStartDayOfWeekNo(Integer.parseInt(DateUtil.getYear()), (currentWeek)) + "-" + DateUtil.getEndDayOfWeekNo(Integer.parseInt(DateUtil.getYear()), (currentWeek)));
        }else {
    ...
    private void initViewTwo() {
        ...
        headLiner2 = (LinearLayout) LayoutInflater.from(AddMineWeeklyActivtiy.this).inflate(R.layout.add_mine_weekly_header, null);
        ...
        adapter2 = new ItemSelectFileAdapter(dataListTwoName, AddMineWeeklyActivtiy.this);
            ...
            case R.id.right_btn:
            {
                ...
                if(currentSelect == 0){
                    ...
                    if(StringUtil.isNullOrEmpty(content_one1.getText().toString())){
                        showMsg(AddMineWeeklyActivtiy.this, "请输入工作成效！");
                        return;
                    }
...
//                }
            ...
            {
                if(currentSelect == 0){
                    Intent intent = new Intent(AddMineWeeklyActivtiy.this, WriteContentActivity.class);
...
//            showMsg(WeeklyDetailActivtiy.this, getResources().getString(R.string.open_file_none));
        ...
        if(resultCode == RESULT_OK && requestCode == REQUEST_CODE){
            ...
            if(pptPath != null){
                ...
                showMsg(AddMineWeeklyActivtiy.this, getResources().getString(R.string.open_file_failed));
            }
        }
    ...
    private void getWeekDateOne() {
        StringRequest request = new StringRequest(
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code1) == 200) {
                                    ...
                                    Toast.makeText(AddMineWeeklyActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("weekCount", "第"+String.valueOf(currentWeek-1)+"周");
    ...
    private void getWeekDateTwo() {
        StringRequest request = new StringRequest(
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> params = new HashMap<String, String>();
                params.put("empId", getGson().fromJson(getSp().getString(Contance.EMP_ID, ""), String.class));
                params.put("weekCount", "第"+String.valueOf(currentWeek)+"周");
                params.put("year", DateUtil.getYear());
                params.put("reportType", "2");
                return params;
            }
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code) == 200) {
                                    ...
                                    showMsg(AddMineWeeklyActivtiy.this, "操作成功");
...
//                                    跳转到周报详情页面
                                    ...
                                    showMsg(AddMineWeeklyActivtiy.this, jo.getString("message"));
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                            ...
                            Toast.makeText(AddMineWeeklyActivtiy.this, R.string.add_failed, Toast.LENGTH_SHORT).show();
                        }
                        if(progressDialog != null){
                            progressDialog.dismiss();
                        }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                if(currentSelect == 0){
                    ...
                    params.put("dateLine", DateUtil.getEndDayOfWeekNo2(Integer.parseInt(DateUtil.getYear()), (currentWeek-1)));
                    ...
                    params.put("dateLine", DateUtil.getEndDayOfWeekNo2(Integer.parseInt(DateUtil.getYear()), (currentWeek)));
