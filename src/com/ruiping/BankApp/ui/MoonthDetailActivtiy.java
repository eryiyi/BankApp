 ...
 * 月报详情
 */
public class MoonthDetailActivtiy extends BaseActivity implements View.OnClickListener , ContentListView.OnRefreshListener, ContentListView.OnLoadListener{
    ...
    private void initView() {
        ...
        headLiner = (LinearLayout) LayoutInflater.from(MoonthDetailActivtiy.this).inflate(R.layout.moonth_detail_header, null);
        ...
        adapter = new ItemCommentAdapter(lists, MoonthDetailActivtiy.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position-2 < lists.size()){
                    ...
                    Intent intent = new Intent(MoonthDetailActivtiy.this, AddDailyCommentActivity.class);
        ...
        adapterT = new ItemDoneAdapter(listsDone, MoonthDetailActivtiy.this);
        ...
        switch (v.getId()){
                ...
                //添加评论
            {
                if(bankJobReport != null){
                    ...
                    showMsg(MoonthDetailActivtiy.this, "请先添加月报！");
                    return;
                }
            }
                break;
...
//                if(bankJobReport != null){
                    //附件查看
                    Intent intent  = new Intent(MoonthDetailActivtiy.this, AttachMentActivity.class);
...
//                }
//                else{
//                    Intent intent  = new Intent(MoonthDetailActivtiy.this, AttachMentUpWeekActivity.class);
...
//                }
            ...
            {
                if(flag){
                    Intent intent = new Intent(MoonthDetailActivtiy.this, WriteContentActivity.class);
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (data.getCode() == 200) {
                                ...
                                Toast.makeText(MoonthDetailActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(MoonthDetailActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            Toast.makeText(MoonthDetailActivtiy.this, R.string.add_failed, Toast.LENGTH_SHORT).show();
                        }
                        if(progressDialog != null){
                            progressDialog.dismiss();
                        }
    ...
    void getDetailById(){
        //判断是否有网
        try {
            isMobileNet = HttpUtils.isMobileDataEnable(MoonthDetailActivtiy.this);
            isWifiNet = HttpUtils.isWifiDataEnable(MoonthDetailActivtiy.this);
            if (!isMobileNet && !isWifiNet) {
                showMsg(MoonthDetailActivtiy.this, "请检查您的网络链接");
            } else {
                StringRequest request = new StringRequest(
                        Request.Method.POST,
