 ...
 * 评论我的
 */
public class WeeklyCommentActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        progressDialog = new CustomProgressDialog(WeeklyCommentActivity.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    private void initView() {
        ...
        adapter = new ItemWeeklyAdapter(lists, WeeklyCommentActivity.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(WeeklyCommentActivity.this, WeeklyDetailActivtiy.class);
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code1) == 200) {
                                    ...
                                    Toast.makeText(WeeklyCommentActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.right_btn:
                //添加周报
            {
                Intent intent = new Intent(WeeklyCommentActivity.this, AddMineWeeklyActivtiy.class);
                startActivity(intent);
            }
            break;
        }
