 ...
 * 下属年度报告
 */
public class YearXiashuActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        progressDialog = new CustomProgressDialog(YearXiashuActivity.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    private void initView() {
        ...
        title.setText("下属年度报告");
        adapter = new ItemWeeklyAdapter(lists, YearXiashuActivity.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(YearXiashuActivity.this, YearDetailActivtiy.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.right_btn:
                //添加年度报告
            {
                Intent intent = new Intent(YearXiashuActivity.this, AddYearActivtiy.class);
                startActivity(intent);
            }
            break;
        }
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code1) == 200) {
                                    ...
                                    Toast.makeText(YearXiashuActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
