 ...
 * 下属年中报告
 */
public class YearMiddleXiashuActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        progressDialog = new CustomProgressDialog(YearMiddleXiashuActivity.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    private void initView() {
        ...
        title.setText("下属年中报告");
        adapter = new ItemWeeklyAdapter(lists, YearMiddleXiashuActivity.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(YearMiddleXiashuActivity.this, YearMiddleDetailActivtiy.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.right_btn:
                //添加年中报告
            {
                Intent intent = new Intent(YearMiddleXiashuActivity.this, AddYearMiddleActivtiy.class);
                startActivity(intent);
            }
            break;
        }
    ...
    private void getWeekDate() {
        StringRequest request = new StringRequest(
                Request.Method.POST,
                InternetURL.WEEK_ALL_SUBORDINATE_URL,
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code1) == 200) {
                                    ...
                                    Toast.makeText(YearMiddleXiashuActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
