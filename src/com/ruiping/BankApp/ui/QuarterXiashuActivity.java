 ...
 * 下属季报
 */
public class QuarterXiashuActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        progressDialog = new CustomProgressDialog(QuarterXiashuActivity.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    private void initView() {
        ...
        title.setText("下属季报");
        adapter = new ItemWeeklyAdapter(lists, QuarterXiashuActivity.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(QuarterXiashuActivity.this, QuarterDetailActivtiy.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.right_btn:
                //添加季报
            {
                Intent intent = new Intent(QuarterXiashuActivity.this, AddQuarterMonthActivtiy.class);
                startActivity(intent);
            }
            break;
        }
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code1) == 200) {
                                    ...
                                    Toast.makeText(QuarterXiashuActivity.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
