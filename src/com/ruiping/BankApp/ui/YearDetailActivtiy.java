 ...
 * 年度报告详情
 */
public class YearDetailActivtiy extends BaseActivity implements View.OnClickListener , ContentListView.OnRefreshListener, ContentListView.OnLoadListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bankJobReport != null && !StringUtil.isNullOrEmpty(bankJobReport.getReportId())){
            progressDialog = new CustomProgressDialog(YearDetailActivtiy.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    private void initView() {
        ...
        headLiner = (LinearLayout) LayoutInflater.from(YearDetailActivtiy.this).inflate(R.layout.moonth_detail_header, null);
        ...
        adapter = new ItemCommentAdapter(lists, YearDetailActivtiy.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position-2 < lists.size()){
                    ...
                    Intent intent = new Intent(YearDetailActivtiy.this, AddDailyCommentActivity.class);
        ...
        adapterT = new ItemDoneAdapter(listsDone, YearDetailActivtiy.this);
        ...
        switch (v.getId()){
            ...
            case R.id.right_btn:
            {
                ...
                if(StringUtil.isNullOrEmpty(content_one.getText().toString())){
                    showMsg(YearDetailActivtiy.this, "请输入工作成效！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(content_two.getText().toString())){
                    showMsg(YearDetailActivtiy.this, "请输入工作总结！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(content_three.getText().toString())){
                    showMsg(YearDetailActivtiy.this, "请输入工作计划！");
                    return;
                }
                if(bankJobReport !=null){
                    updateWeekly();
                ...
                //添加评论
            {
                if(bankJobReport != null){
                    ...
                    showMsg(YearDetailActivtiy.this, "请先添加季报！");
                    return;
                }
            }
                break;
...
//                if(bankJobReport != null){
                    //附件查看
                    Intent intent  = new Intent(YearDetailActivtiy.this, AttachMentActivity.class);
...
//                }
            ...
            {
                if(flag){
                    Intent intent = new Intent(YearDetailActivtiy.this, WriteContentActivity.class);
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (data.getCode() == 200) {
                                ...
                                Toast.makeText(YearDetailActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(YearDetailActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                        }
...
//                                    finish();
                                    ...
                                    showMsg(YearDetailActivtiy.this, jo.getString("message"));
                                }
                            ...
                            Toast.makeText(YearDetailActivtiy.this, R.string.add_failed, Toast.LENGTH_SHORT).show();
                        }
                        if(progressDialog != null){
                            progressDialog.dismiss();
                        }
    ...
    void getDetailById(){
        //判断是否有网
        try {
            isMobileNet = HttpUtils.isMobileDataEnable(YearDetailActivtiy.this);
            isWifiNet = HttpUtils.isWifiDataEnable(YearDetailActivtiy.this);
            if (!isMobileNet && !isWifiNet) {
                showMsg(YearDetailActivtiy.this, "请检查您的网络链接");
            } else {
                StringRequest request = new StringRequest(
                        Request.Method.POST,
