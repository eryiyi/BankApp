 ...
 * 年中报告详情
 */
public class YearMiddleDetailActivtiy extends BaseActivity implements View.OnClickListener , ContentListView.OnRefreshListener, ContentListView.OnLoadListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bankJobReport != null && !StringUtil.isNullOrEmpty(bankJobReport.getReportId())){
            progressDialog = new CustomProgressDialog(YearMiddleDetailActivtiy.this, "正在加载中",R.anim.custom_dialog_frame);
    ...
    private void initView() {
        ...
        headLiner = (LinearLayout) LayoutInflater.from(YearMiddleDetailActivtiy.this).inflate(R.layout.moonth_detail_header, null);
        ...
        adapter = new ItemCommentAdapter(lists, YearMiddleDetailActivtiy.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position-2 < lists.size()){
                    ...
                    Intent intent = new Intent(YearMiddleDetailActivtiy.this, AddDailyCommentActivity.class);
        ...
        adapterT = new ItemDoneAdapter(listsDone, YearMiddleDetailActivtiy.this);
        ...
        switch (v.getId()){
            ...
            case R.id.right_btn:
            {
                ...
                if(StringUtil.isNullOrEmpty(content_one.getText().toString())){
                    showMsg(YearMiddleDetailActivtiy.this, "请输入工作成效！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(content_two.getText().toString())){
                    showMsg(YearMiddleDetailActivtiy.this, "请输入工作总结！");
                    return;
                }
                if(StringUtil.isNullOrEmpty(content_three.getText().toString())){
                    showMsg(YearMiddleDetailActivtiy.this, "请输入工作计划！");
                    return;
                }
                if(bankJobReport !=null){
                    updateWeekly();
                ...
                //添加评论
            {
                if(bankJobReport != null){
                    ...
                    showMsg(YearMiddleDetailActivtiy.this, "请先添加季报！");
                    return;
                }
            }
                break;
...
//                if(bankJobReport != null){
                    //附件查看
                    Intent intent  = new Intent(YearMiddleDetailActivtiy.this, AttachMentActivity.class);
                    ...
                    startActivity(intent);
//                }else{
//                    Intent intent  = new Intent(YearMiddleDetailActivtiy.this, AttachMentUpWeekActivity.class);
...
//                }
            ...
            {
                if(flag){
                    Intent intent = new Intent(YearMiddleDetailActivtiy.this, WriteContentActivity.class);
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (data.getCode() == 200) {
                                ...
                                Toast.makeText(YearMiddleDetailActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(YearMiddleDetailActivtiy.this, R.string.get_data_error, Toast.LENGTH_SHORT).show();
                        }
    ...
    private void updateWeekly() {
        StringRequest request = new StringRequest(
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if (Integer.parseInt(code) == 200) {
                                    ...
                                    showMsg(YearMiddleDetailActivtiy.this, jo.getString("message"));
                                }
                            ...
                            Toast.makeText(YearMiddleDetailActivtiy.this, R.string.add_failed, Toast.LENGTH_SHORT).show();
                        }
                        if(progressDialog != null){
                            progressDialog.dismiss();
                        }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("reportType", bankJobReport.getReportType());
    ...
    void getDetailById(){
        //判断是否有网
        try {
            isMobileNet = HttpUtils.isMobileDataEnable(YearMiddleDetailActivtiy.this);
            isWifiNet = HttpUtils.isWifiDataEnable(YearMiddleDetailActivtiy.this);
            if (!isMobileNet && !isWifiNet) {
                showMsg(YearMiddleDetailActivtiy.this, "请检查您的网络链接");
            } else {
                StringRequest request = new StringRequest(
                        Request.Method.POST,
