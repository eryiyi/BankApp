package com.ruiping.BankApp.huanxin;
...
import com.ruiping.BankApp.huanxin.domain.InviteMessage;
import com.ruiping.BankApp.huanxin.domain.InviteMessage.InviteMesageStatus;
import com.ruiping.BankApp.huanxin.domain.RobotUser;
import com.ruiping.BankApp.huanxin.parse.UserProfileManager;
import com.ruiping.BankApp.huanxin.receiver.CallReceiver;
import com.ruiping.BankApp.huanxin.ui.ChatActivity;
import com.ruiping.BankApp.huanxin.utils.PreferenceManager;
    	...
    	messageListener = new EMMessageListener() {
			...
			public void onMessageReceived(List<EMMessage> messages) {
			    for (EMMessage message : messages) {
                    ...
                    // 存入db
                    UserDao dao = new UserDao(BankAppApplication.getContext());
