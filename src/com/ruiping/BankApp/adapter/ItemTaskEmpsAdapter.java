 ...
 */
public class ItemTaskEmpsAdapter extends BaseAdapter {
     ...
     * 数据集合
     */
    private List<BankEmpBean> datas = null;
    ...
    public ItemTaskEmpsAdapter(Context context, List<BankEmpBean> datas) {
        this.datas = datas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        BankEmpBean bean = datas.get(position);
...
//        boolean canRemove = bean.isCanRemove();
        ...
        tvTitle.setText(bean.getEmpName());
...
//        }
     ...
     * 增加一项的时候
     */
    public void add(BankEmpBean bean) {
    ...
    public List<BankEmpBean> getDatas() {
        return datas;
    }
