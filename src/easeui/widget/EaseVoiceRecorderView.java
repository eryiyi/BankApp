...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    protected easeui.model.EaseVoiceRecorder voiceRecorder;
    ...
    private void init(Context context) {
        ...
        voiceRecorder = new easeui.model.EaseVoiceRecorder(micImageHandler);
    ...
    public boolean onPressToSpeakBtnTouch(View v, MotionEvent event, EaseVoiceRecorderCallback recorderCallback) {
        ...
        case MotionEvent.ACTION_DOWN:
            try {
                if (easeui.widget.chatrow.EaseChatRowVoicePlayClickListener.isPlaying)
                    easeui.widget.chatrow.EaseChatRowVoicePlayClickListener.currentPlayListener.stopPlayVoice();
                v.setPressed(true);
                startRecording();
            } catch (Exception e) {
                v.setPressed(false);
    ...
    public void startRecording() {
        if (!easeui.utils.EaseCommonUtils.isSdcardExist()) {
