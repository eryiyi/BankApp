...
public class EaseContactList extends RelativeLayout {
    ...
    protected List<BankEmpBean> contactList;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_UPDATE_LIST:
                if(adapter != null){
                	adapter.clear();
//                	adapter.addAll(new ArrayList<BankEmpBean>(contactList));
//                	adapter.notifyDataSetChanged();
     ...
     * init view
     */
    public void init(List<BankEmpBean> contactList){
    	this.contactList = contactList;
        adapter = new EaseContactAdapter(context, 0, new ArrayList<BankEmpBean>(contactList));
