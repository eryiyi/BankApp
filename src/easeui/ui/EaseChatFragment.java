 ...
 *
 */
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener,EaseChatFragmentHelper {
...
//        }
        ...
        String userPic = getGson().fromJson(getSp().getString(Contance.EMP_COVER, ""), String.class);
        if (!TextUtils.isEmpty(userPic)) {
            message.setAttribute("userPic", userPic);
        }
        String userName = getGson().fromJson(getSp().getString(Contance.EMP_NAME, ""), String.class);
