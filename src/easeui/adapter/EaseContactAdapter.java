...
public class EaseContactAdapter extends ArrayAdapter<EaseUser> implements SectionIndexer{
    ...
    List<String> list;
    List<BankEmpBean> userList;
    List<BankEmpBean> copyUserList;
    ...
    public EaseContactAdapter(Context context, int resource, List<BankEmpBean> objects) {
        super(context, resource);
        this.res = resource;
        this.userList = objects;
        copyUserList = new ArrayList<BankEmpBean>();
    ...
    protected class  MyFilter extends Filter{
        List<BankEmpBean> mOriginalList = null;
        
        public MyFilter(List<BankEmpBean> myList) {
        ...
        protected synchronized FilterResults performFiltering(CharSequence prefix) {
            ...
            if(mOriginalList==null){
                mOriginalList = new ArrayList<BankEmpBean>();
            }
            ...
            if(prefix==null || prefix.length()==0){
                ...
                final ArrayList<BankEmpBean> newValues = new ArrayList<BankEmpBean>();
                for(int i=0;i<count;i++){
                    final BankEmpBean user = mOriginalList.get(i);
        ...
        protected synchronized void publishResults(CharSequence constraint,
            ...
            userList.clear();
            userList.addAll((List<BankEmpBean>)results.values);
